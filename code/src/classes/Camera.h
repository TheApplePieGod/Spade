...
public:
	...
	camera(f32 Width, f32 Height)
	{
		...
		CameraInfo.Transform.Location.z = -1300.f;
	...
	v3 ForwardVector = { 0.f, 1.f, 0.f };
	v3 RightVector = { 1.f, 0.f, 0.f };
	v3 UpVector = { 0.f, 0.f, -1.f }; // static for now
	v3 LookAtVector = { 0.f, 1.f, 0.f };

	f32 MouseInputScale = 0.1f;
